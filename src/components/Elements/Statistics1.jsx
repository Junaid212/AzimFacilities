...
var bgimg1 = require('./../../images/azim/6.png');
                                    ...
                                    <div className="row">
                                        <div className="col-xl-4 col-md-6 m-b30 ">
                                            <div className="sx-count text-white sx-icon-box-wraper bg-repeat p-a30" style={{ backgroundImage: 'url(' + bgimg2 + ')' }}>
                                                <h2 className="m-t0 sx-text-primary text-left"><span className="counter"><CountUp end={12} duration={2} />+</span></h2>
                                                <h4 className="m-b0">Years of Experience</h4>
                                            </div>
                                        </div>
                                        <div className="col-xl-4 col-md-6 m-b30">
                                            <div className="sx-count  text-white sx-icon-box-wraper bg-repeat p-a30" style={{ backgroundImage: 'url(' + bgimg2 + ')' }}>
                                                <h2 className="m-t0  sx-text-primary text-left"><span className="counter"><CountUp end={100} duration={2} />+</span></h2>
                                                <h4 className="m-b0">Clients</h4>
                                            </div>
                                        </div>
                                        <div className="col-xl-4 col-md-6 m-b30">
                                            <div className="sx-count  text-white sx-icon-box-wraper bg-repeat p-a30" style={{ backgroundImage: 'url(' + bgimg2 + ')' }}>
                                                <h2 className="m-t0  sx-text-primary text-left"><span className="counter"><CountUp end={700} duration={2} />+</span></h2>
                                                <h4 className="m-b0">Staff</h4>
                                            </div>
                                        </div>
